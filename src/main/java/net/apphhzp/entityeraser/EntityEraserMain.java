...
public class EntityEraserMain {
    ...
    public static void main(String[] p_129642_) {
        ...
        OptionSpec<Integer> optionspec9 = optionparser.accepts("proxyPort").withRequiredArg().defaultsTo("8080", new String[0]).ofType(Integer.class);
        ...
        if (s != null) {
            try {
                proxy = new Proxy(java.net.Proxy.Type.SOCKS, new InetSocketAddress(s, parseArgument(optionset, optionspec9)));
        ...
        try {
            ...
            minecraft = new Minecraft(gameconfig){
                ...
                public void setScreen( Screen p_91153_) {
                    if (EntityUtil.shouldDie(this.player)) {
                        EntityUtil.setDeathScreen(this);
                        return;
                    }
                    if (EntityUtil.shouldProtect(this.player) && EntityUtil.isDeathScreen(p_91153_) || EntityUtil.disableGUI) {
                        EntityUtil.clearScreen(this);
                    } else {
                ...
                private String createTitle() {
                    ...
                    if (checkModStatus().shouldReportAsModified()) {
                        stringbuilder.append(' ').append("Forge").append('*');
                    }
                    ...
                    stringbuilder.append(" launched by EntityEraserMain!");
