...
public class EntityeraserModItems {
	...
	public static final RegistryObject<Item> GDI_KILL_SELF_ITEM= ClassHelperSpecial.isWindows?REGISTRY.register("gdi_kill_self",GdiKillselfItem::new):null;
	public static final RegistryObject<Item> TIME_STOP_ITEM=REGISTRY.register("time_stop",TimeStopItem::new);
}
